...
public class YamlBuild<T extends AbstractProject & TopLevelItem>
  ...
  protected class YamlExecution extends AbstractBuild.AbstractRunner {
      ...
      try {
        ...
        do {
          try {
            ...
            final Queue.Item currentItem = Queue.getInstance().getItem(item.getId());
    ...
    private JSONObject readToJSON(FilePath yamlFile) throws IOException, InterruptedException {
