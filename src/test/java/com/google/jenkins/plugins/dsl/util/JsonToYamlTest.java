...
public class JsonToYamlTest {
  ...
  private void testOneTranslation(JsonToYaml underTest, String name)
      throws IOException {
    ...
    final String yaml = read(yamlStream);

    System.out.println("Testing: " + name);

    assertEquals(yaml, underTest.toYaml(jsonStream));
  }
